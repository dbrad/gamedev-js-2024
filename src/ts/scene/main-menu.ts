...
export let create_main_menu = (root_id: number): number =>
{
...
let update_main_menu = (node_id: number, x: number, y: number, delta: number): void =>
{
    if (A_PRESSED)
    {
...
let draw_main_menu = (node_id: number, x: number, y: number, delta: number): void =>
{
