...
declare const ATLAS_HEIGHT: 32;

declare const PXX0: 2;
declare const PXX1: 3;
declare const PXY0: 1;
declare const PXY1: 2;

declare const PXU0: 0.00390625;
declare const PXU1: 0.005859375;
declare const PXV0: 0.03125;
declare const PXV1: 0.0625;
...
declare const TEXTURE_D_PAD_DOWN: 10;
declare const TEXTURE_D_PAD_LEFT: 11;
declare const TEXTURE_A_BUTTON_UP: 12;
declare const TEXTURE_B_BUTTON_UP: 13;
declare const TEXTURE_A_BUTTON_DOWN: 14;
declare const TEXTURE_B_BUTTON_DOWN: 15;
declare const TEXTURE_GRASS_1: 16;
declare const TEXTURE_GRASS_2: 17;
declare const TEXTURE_GRASS_3: 18;
declare const TEXTURE_GRASS_4: 19;
declare const TEXTURE_FLOWERS: 20;

declare const TAG_NONE: 0;
declare const TAG_PLAYER: 1;
declare const TAG_ENEMY: 2;

declare const DIRECTION_UP: 0;
declare const DIRECTION_RIGHT: 1;
declare const DIRECTION_DOWN: 2;
declare const DIRECTION_LEFT: 3;

declare const SCREEN_UNKNOWN: 0;
declare const SCREEN_INIT: 1;
declare const SCREEN_MENU: 2;
declare const SCREEN_OPTIONS: 3;
declare const SCREEN_GAME: 4;
